...
<html class="error-page">
    <head>
        <title>500 error page | 正和岛-中国商界第一高端人脉与网络社交平台</title>
                ...
                <div class="col-lg-12">
                    <div class="centering text-center">
                        <div class="text-center">
                            <h2 class="without-margin">Don't worry. It's <span class="text-success"><big>500</big></span> error only.</h2>
                            <h4 class="text-success">Something is broken, but we will fix it soon</h4>
                        </div>
                        <!-- 
                        <div class="text-center">
