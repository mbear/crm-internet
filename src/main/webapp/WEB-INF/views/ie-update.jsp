                ...
                <div class="col-md-12">
                    <div class="centering text-center">
                        <div class="text-center">
                            <h2 class="without-margin"><span class="text-success"><big>入岛申请表</big></span></h2>
                            <h4 class="text-success">您使用的浏览器版本过低</h4>
                            <h4 class="text-success">建议您升级到 <a href="http://www.microsoft.com/china/windows/internet-explorer/">Internet Explorer 8 或更高版本</a> 或以下浏览器： <a href="http://www.firefox.com.cn/">Firefox</a> / <a href="http://www.google.cn/intl/zh-CN/chrome/">Chrome</a> / <a href="http://se.360.cn/">360安全浏览器</a></h4>
                        </div>
                        <hr/>
                   </div>
                   <div class="row-fluid">
                            ...
                            <ul>
                              <li>申请资料：</li>
                                <ol>
                                  ...
                                  <li>正和岛入岛声明&nbsp;&nbsp;<a href="<%=request.getContextPath()%>/resources/正和岛入岛声明.docx">入岛声明（非投资类）</a>&nbsp;&nbsp;<a href="<%=request.getContextPath()%>/resources/正和岛入岛声明 - 投资类企业.docx">入岛声明（投资类）</a></li>
                                  <li>申请人个人照片（提交电子版）</li>
                                </ol>
                              <li>资质证明：</li>
                                <ol>
